    ...
    public partial class Form1 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show($"Task ended in {stopwatch.ElapsedMilliseconds / 1000.0} seconds");
        ...
        private async Task ProccessCards(List<string> cards)
        {
        ...
        private List<string> ObtainCreditCards(int CardQuantity)
        {
